...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const WRAPPED_COINS_SYMBOLS = ['wbtc', 'weth', 'seth' ,'wsteth', 'weeth', 'cbbtc' , 'reth', 'rseth' , 'meth' ,'lbtc', 'clbtc', 'ezeth' , 'wbnb', 'solvbtc' , 'oseth' , 'steth']; // Adicione outros símbolos conforme necessário, SEMPRE EM MINÚSCULAS
    // -------------------------------------------------------------------------
